...
def normalisation(tweet):
	...
	hashtag_removed = html_removed.replace('#','') #re.sub(r"(?:\#+[\w_]+[\w\'_\-]*[\w_]+)", '', html_removed)
...
print (normalisation("@george <br> this   #soccer  á ? ! ---  $ http://google.com Epizode from #narcos was fucking amazin!"))